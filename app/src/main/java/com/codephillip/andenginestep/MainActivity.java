...
public class MainActivity extends SimpleBaseGameActivity {
    ...
    private static int CAMERA_LENGTH = 640;
    ...
    protected void onCreateResources() throws IOException {
        ...
        bitmapTextureAtlas = new BitmapTextureAtlas(this.getTextureManager(), 256, 256, TextureOptions.DEFAULT);
        circleRegion = BitmapTextureAtlasTextureRegionFactory.createFromAsset(bitmapTextureAtlas, this,"circle.png",0 ,0 );
    ...
    protected Scene onCreateScene() {
        ...
        sprite = new Sprite(300, 300, circleRegion, this.getVertexBufferObjectManager());
